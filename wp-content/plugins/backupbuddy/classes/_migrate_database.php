...
class backupbuddy_migrateDB {
	...
	function migrateNetworkToNetwork() {
		...
		mysql_query( "UPDATE `" . $this->restoreData['databaseSettings']['prefix'] . "blogs` SET domain='" . backupbuddy_core::dbEscape( $multisite_destination_domain ) . "' WHERE domain='" . backupbuddy_core::dbEscape( $old_domain ) . "'" );
		...
		// Update blog domain for all matching sites.
		mysql_query( "UPDATE `" . $this->restoreData['databaseSettings']['prefix'] . "site` SET domain='" . backupbuddy_core::dbEscape( $multisite_destination_domain ) . "' WHERE domain='" . backupbuddy_core::dbEscape( $old_domain ) . "'" );
